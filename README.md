...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lsnuyl4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lsnuyl4.containers.anotherwebservice.com/
...
```
git clone git@github.com:ykarous/container-lsnuyl4.git
cd container-lsnuyl4
```
...
```
docker attach container-lsnuyl4
```
